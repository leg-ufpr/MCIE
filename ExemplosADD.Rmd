...
- (ii) $\lambda_2(x_i,x_j) \equiv \lambda_2(\|x_i-x_j\|)$ \hspace{0.2in} (depende apenas da distância $s=\|x_i-x_j\|$);
...
- (i) definir o região para simulação;
- (ii) encontrar o número esperado de eventos na região $\lambda \Delta_t$;
- (iii) simular o número $N$ de eventos de uma Poisson com média $\lambda \Delta_t$;
- (iv) obter as localizações dos eventos simulando de uma distribuição uniforme sobre a região.
